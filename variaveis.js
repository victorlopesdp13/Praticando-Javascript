...
let vasilha_1 = "Chocolate";  // atribuição de valores a variáveis
...
tabuleiro = tabuleiro + ", " + vasilha_mistura; // tambem pode ser usado tabuleiro += vasilha_mistura;
